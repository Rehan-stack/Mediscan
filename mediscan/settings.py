...
ASGI_APPLICATION = 'mediscan.asgi.application'
...
SMTP_PORT = 587
SMTP_USER = 'chaule713@gmail.com'
SMTP_PASSWORD = 'wrlg ivaq uhve lgdy'
...
EMAIL_HOST_PASSWORD = 'wrlg ivaq uhve lgdy'
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
